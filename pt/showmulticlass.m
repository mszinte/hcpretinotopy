function [images,maskimages] = showmulticlass(vid,outfile,offset,movieflip,frameduration,fixationinfo,fixationsize, ...
...
if iscolor
  ...
  [timeframes,timekeys,digitrecord,trialoffsets] = ptviewmovie(vid, images, ...
